...
class HandController(CalibrationClass):
    ...
    def __init__(self, port: str = '/dev/ttyUSB0', config_yml: str = "hand_defs.yaml", calibration: bool = False, auto_calibrate: bool = False, maxCurrent: int = 100, lock_motors: bool = False):
        """
        ...
        print(self.motor_ids, port, baudrate)
    ...
    def init_joints(self, calibrate: bool = False, auto_calibrate: bool = False, calib_current: int = 100, maxCurrent: int = 100):
        """
