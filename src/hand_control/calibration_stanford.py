...
class CalibrationClass():
    ...
    def auto_calibrate_fingers_with_pos(self, calib_current=10, maxCurrent: int = 10):
            """
    ...
    def calibrate_wrist_pitch_pos(self, yaml_file_path, calib_current=10, maxCurrent: int = 10, skip_calibration=False):
        """
