...
class CalibrationClass():
    ...
    def auto_calibrate_fingers_with_pos(self, calib_current=300, maxCurrent: int = 300):
            ...
            wrist_init_pos = self.calibrate_wrist_pitch_pos(file_path, 15, maxCurrent, skip_calibration=True)
            # Open the YAML file
    ...
    def calibrate_wrist_pitch_pos(self, yaml_file_path, calib_current=160, maxCurrent: int = 150, skip_calibration=False):
        ...
        if not skip_calibration:
            ...
            motor_pos_calib[wrist_motor_idx] = -calib_current
            wrist_pos_flexed = self.move_to_limit_and_get_pos(motor_pos_calib, calibration_current=calib_current, position_increment=0.1, threshold=0.05, wait_time=0.1)[wrist_motor_idx]
